				...
				<div class="flex flex-wrap px-4">
					...
					<form action="{{ home_url() }}" role="search">
						<div class="bg-grey-lighter rounded-full lg:rounded lg:w-64 flex rounded relative">
							...
							<input name="s" id="main-search" autocomplete="off" data aria-label="Sök på webbplatsen" placeholder="Sök på webbplatsen" class="hidden lg:inline-block text-base bg-transparent h-12 pin-t px-4 pin-l w-full" type="search">
