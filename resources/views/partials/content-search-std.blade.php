...
<article class="search-item py-4 border-b border-grey-lightest" data-category="{{ $result->category }}">
	<a href="{{ isset($result->url) ? $result->url : ''  }}" target="_blank" title="{{ isset($result->title) ? $result->title : '' }}" class="text-blue-dark mb-2 inline-block hover:bg-yellow-light focus:bg-yellow-light">
