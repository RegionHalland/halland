<?php 
    ...
    'fields' => array(
        ...
        2 => array(
            'key' => 'field_5b323b4a6c2d7',
            'label' => __('Nyheter', 'halland'),
            'name' => '',
            'type' => 'tab',
            'instructions' => '',
            'required' => 0,
        ...
        3 => array(
            'key' => 'field_5b323b6e6c2d8',
            'label' => __('Taggar', 'halland'),
            'name' => 'show_tags',
            'type' => 'true_false',
            'instructions' => __('Aktiverar "taggar" för inlägg', 'halland'),
            'required' => 0,
            'conditional_logic' => 0,
            'wrapper' => array(
                'width' => '',
            ...
            'message' => __('Aktivera taggar', 'halland'),
            'default_value' => 0,
            'ui' => 0,
            'ui_on_text' => '',
            'ui_off_text' => '',
